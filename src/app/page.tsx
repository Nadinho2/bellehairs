  ...
  return (
    <div className="relative w-[270px] shrink-0 overflow-hidden rounded-3xl border border-black/10 bg-white shadow-sm transition hover:shadow-md sm:w-auto">
      <button
        ...
        className="absolute right-3 top-3 z-10 inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/95 text-black shadow-sm"
        aria-label="Toggle wishlist"
      >
        <HeartIcon className="h-5 w-5" filled={wishlist.ids.includes(product.id)} />
      </button>
      ...
      <div className="space-y-3 p-4">
        <div className="space-y-1">
          ...
          <p className="font-semibold text-black">{formatPrice(product.price)}</p>
        </div>
